...
public class ShiroListener extends EnvironmentLoaderListener {
    ...
    protected WebEnvironment createEnvironment(ServletContext sc) {
        ...
        org.apache.shiro.web.filter.authc.FormAuthenticationFilter authcFilter = (org.apache.shiro.web.filter.authc.FormAuthenticationFilter) filterChainManager
                .getFilter("authc");
        authcFilter.setLoginUrl("/");

        // Configure chains
        filterChainManager.createChain("/api/rs/**", "bearer");
        filterChainManager.createChain("/portal/logout", "logout");
        filterChainManager.createChain("/secure.html", "authc");

        // Allow pure anonymous access to everything else
